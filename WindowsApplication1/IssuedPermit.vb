...
Public Class IssuedPermit
    ...
    Private Sub BtnSearchRecord_Click(sender As Object, e As EventArgs) Handles BtnSearchRecord.Click
        Try
            Inspector_DashBoard.DataGrid.Rows.Clear()
    ...
    Private Sub SaveNow_Click(sender As Object, e As EventArgs) Handles SaveNow.Click
        ...
        Try
            ...
            If Issued_attachment.Text = "" Then

                MsgBox(" No Issuance Permit Attachment")
                Exit Sub
            End If
            ...
            Dim filename = referencono.Text & "_IssuancePermit.pdf"
            ...
            Con_ms1.Open()
            conn_ms1 = "UPDATE ONLINE.annual_inspection_application SET app_status = 'I', permitfileissuance = @issuedPermit, issuancedate = @date where id='" & TxtApplicationID.Text & "'"
            cmd_ms1 = New SqlCommand(conn_ms1, Con_ms1)
            cmd_ms1.Parameters.Add("@date", SqlDbType.DateTime).Value = DateAndTime.Now()
            cmd_ms1.Parameters.Add("@issuedPermit", SqlDbType.VarChar).Value = filename
            ...
            conn = "INSERT INTO ONLINE.email_outbox (userid, accountno, email, Subject, fullname, referencecode, datesend, assessment_path) " _
               & "VALUES (@userid, @tdn, '" & txt_email.Text & "', 'Construction Permit Issuance' ,@applicant, '" & referencono.Text & "', @Date, @filePath)"
            cmd_ms = New SqlCommand(conn, Con_ms)
    ...
    Private Sub ORlink_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles ORlink.LinkClicked
