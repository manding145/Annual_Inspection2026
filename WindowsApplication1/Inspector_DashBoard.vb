...
Public Class Inspector_DashBoard
                ...
                If rdr_ms.Read = True Then
                    ...
                    With Inspector_ApplicationRecord
                        ...
                        If rdr_ms("app_status") = "P" Then
                            ...
                            .B_assessAttach.Visible = True
                            .B_assessAttach.Enabled = True
                        ...
                        Do While rdr_ms2.Read = True
                            ...
                            attach_code_temp = rdr_ms2("attachmentCode").ToString()
        ...
        Try
            If cmb_appointmentstatus.Text = "ALL" Then
                ...
                conn_ms = "SELECT * " &
                          ...
                          "(app_status = 'P' AND CONVERT(date, application_date) BETWEEN '" & Format(dt_Appoinment.Value, "yyyy-MM-dd") & "' AND '" & Format(dt_Appoinment1.Value, "yyyy-MM-dd") & "') " &
