    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            conn = "INSERT INTO ONLINE.email_outbox (userid, accountno, Remarks, email, Subject, fullname, referencecode, datesend) " _
               & "VALUES (@userid, @fullname,  @Remarks, '" & Construction_ApplicationRecord.txt_email.Text & "', 'Construction Permit Deny Application' ,@fullname, '" & Construction_ApplicationRecord.TxtRefenceNo.Text & "', @Date)"
            ...
            Con_ms = New SqlConnection(mcs)
            Con_ms.Open()
            conn_ms = "UPDATE ONLINE.annual_inspection_application set app_status = 'D', remark = @Remarks, deny_date = @date, user_deny='" & Construction_ApplicationRecord.fullname.Text & "' WHERE id='" & Construction_ApplicationRecord.txt_applicationno.Text & "'"
