...
Public Class Print_InspectionRecord1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Print_InspectionRecord.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Print_InspectionRecord.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedPrint_InspectionRecord1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Print_InspectionRecord = New Print_InspectionRecord()
        rpt.Site = Me.Site
        Return rpt
    End Function
